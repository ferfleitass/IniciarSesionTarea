...
class UserCreateAndLoginView(CreateView):
    ...
    template_name = "accounts/signup.html"  # Asegúrate de que el path a tu template sea correcto
    success_url = reverse_lazy("blog:index")  # Ajusta la URL de éxito según tus necesidades
